...
You are also given the array students of length n, where students[j] is the position of 
the jth student.
...
int main() {
    ...
    cout << minMovesToSeat(seats, students, n);
...
class Solution {
private:
    int result(vector<int>& seats, vector<int>& students) {
    int n = seats.size();
